...
namespace FTGA.BirdClips.Droid.Fragments
{
    ...
    [Register("ftga.birdclips.droid.fragments.MyListsFragment")]
    public class MyListsFragment : MvxFragment<MyListsViewModel>
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, Android.Views.ViewGroup container, Android.OS.Bundle savedInstanceState)
        {
            ...
            var view = inflater.Inflate(Resource.Layout.fragment_my_lists, null);
