...
namespace FTGA.BirdClips.Droid.Fragments
{
    ...
    [Register("ftga.birdclips.droid.fragments.ResourcesFragment")]
    public class ResourcesFragment : MvxFragment<ResourcesViewModel>
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, Android.Views.ViewGroup container, Android.OS.Bundle savedInstanceState)
        {
            ...
            var view = inflater.Inflate(Resource.Layout.fragment_resources, null);
